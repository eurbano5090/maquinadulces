	...
	public static void main(String[] args) {
		    ...
		    public static void menu() {
		      ...
		      String[][] nombresGolosinas = {
		            {"KitKat", "M&M", "Chocman", "Gansito"},
		            {"Kinder Sorpresa", "Mentos", "Cheetos", "Twix"},
		            {"Rolls", "M&M'S", "Papa Lays", "Orbix"},
		            {"Skitles", "Ambrosito", "Milkybar", "KitKat'B"}
		        };
		            ...
		            try {
		                ...
		                switch (opcion) {
		                    ...
		                    case 3:
		                        ...
		                        if (cadenaIguales(password, "Maquina2023")) {
		     ...
		     * @param precio 
		     */
		    public static void mostrarGolosinas(String[][] nombres, Integer[][] precio) {
		 
		        for (int i = 0; i < nombres.length; i++) {
		            for (int j = 0; j < nombres[i].length; j++) {
		 
		                System.out.println("|"+ i + "" + j + "| "+ nombres[i][j] + ": " +"$"+""+ precio[i][j]);
